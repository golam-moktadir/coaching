        ...
        <div class="col-12 pl-0 pr-0">
            ...
            <form method="POST" action="{{ route('header-and-footer-save') }}" enctype="multipart/form-data" autocomplete="off" class="form-inline">
                ...
                <div class="form-group col-12 mb-3">
                    ...
                    <input id="address" type="text" class="col-sm-9 form-control @error('address') is-invalid @enderror" name="address" value="{{ old('address') }}" placeholder="Enter Address" required>
                ...
                <div class="form-group col-12 mb-3">
                    ...
                    <input id="copyright" type="text" class="col-sm-9 form-control @error('copyright') is-invalid @enderror" name="copyright" value="{{ old('copyright') }}" placeholder="Enter Copyright" required>
